...
| D7   | Dependabot for npm and GitHub Actions (workflows and the local composite action); cadence, grouping and cooldown: see `.github/dependabot.yml`    | `.github/dependabot.yml`                       | Review |
